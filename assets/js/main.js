...
const visitMessage = "Namaste, I would like to know more about Kala Nidhi by Rajeev Verma.";
...
function imageBlock(item, type = "art") {
  ...
  const label = item.category || item.title || "Kala Nidhi";
...
function artworkCard(item) {
  const message = `Namaste, I am interested in ${item.title} at Kala Nidhi. Please share details.`;
